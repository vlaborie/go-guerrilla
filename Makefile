...
guerrillad:
	$(GO_VARS) $(GO) build -o="guerrillad" -ldflags="$(LD_FLAGS)" -tags default $(ROOT)/cmd/guerrillad

guerrillad-full:
	$(GO_VARS) $(GO) build -o="guerrillad" -ldflags="$(LD_FLAGS)" -tags full $(ROOT)/cmd/guerrillad
